                ...
                <div className="glass-effect shadow-2xl rounded-2xl overflow-hidden fade-in-up">
                    ...
                    <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200/50 bg-white/50">
                        <div className="flex items-center space-x-2">
                            ...
                            <button 
                                type="submit" 
                                className="bg-violet-500 text-white rounded-lg w-14 py-3 font-semibold hover:bg-violet-600 disabled:bg-violet-300 disabled:cursor-not-allowed transition-colors cta-button flex items-center justify-center"
